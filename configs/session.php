 ...
 * <b>use_only_cookies</b>. Ключи: <b>use_cookies</b>, <b>use_only_cookies</b> - должны находиться в секции
 * <b>cookies</b> для корректной работы. Если не подразумевается использовать cookies, то секцию можно не писать.
 *
 ...
 *
 * В ключ <b>active</b> прописывается название текущей используемой конфигурации (конфиграция по умолчанию).
 */
return [
	'default' => [
		'lifeTime' => '5',
